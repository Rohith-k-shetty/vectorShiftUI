...
import { CurrencyConverterNode } from "./nodes/CurrencyConvertorNode";
...
const nodeTypes = {
  ...
  // Added the my 5 newNodes to nodeType
...
export const PipelineUI = () => {
  ...
  // aded the new dependancy array options addNode and getNodeID
